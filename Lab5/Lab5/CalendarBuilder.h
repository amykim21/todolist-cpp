...
class CalendarBuilder {
	//friend std::shared_ptr<DisplayableComponent> removeEvent();	//**
public:
	...
	virtual std::shared_ptr<DisplayableComponent> removeEvent(std::shared_ptr<DisplayableComponent> p, DisplayableEvent* e, std::string name, tm when) = 0;	//**
protected:
